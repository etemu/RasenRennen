 ...
 */
 ...
 /* Die Battles finden ohne die Kategorien U11 und Female statt.
...
echo "<DIV ID='main'>";
	...
	// TODO: zunächst mal prüfen, ob die korrekte Anzahl von Datensätzen in der DB-Tabelle enthalten sind
	
	// Die besten Zeiten in aufsteigender Reihenfolge
	// es werden nur die Anzahl der für das entspr. Battle benötigten Datensätze ausgelesen (my_teilnehmerzahl)
...
<?php	//while ($zeile = $result->fetch_array())
	...
	for ($i = 0; $i < floor($anzahl/2) ; $i++)
	{
		...
		// KAT
		echo "<td style='width:10%; height:20px'>". $row1[4] . "</td>";
